...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1. Agregar clave y valor");
            System.out.println("2. Eliminar clave");
            System.out.println("3. Buscar valor por clave");
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    hashTable.insert(key, value); // Agregar clave y valor a la tabla hash
                    break;

                case 2:
                    System.out.println("Ingrese la clave a eliminar:");
                    String keyToDelete = sc.nextLine();
                    hashTable.delete(keyToDelete); // Eliminar clave de la tabla hash
                    break;

                case 3:
                    System.out.println("Ingrese la clave a buscar:");
                    String keyToSearch = sc.nextLine();
                    int index = hashTable.search(keyToSearch); // Buscar valor por clave en la tabla hash
                    if (index != -1) {
                        System.out.println("Valor encontrado: " + index);
                    } else {
